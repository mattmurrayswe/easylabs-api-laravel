    ...
    <div class="flex">
        ...
        <div id="container-content" class="bg-white w-4/5 ml-[20%] p-20 h-screen">
            ...
            <div id="tabela-medicamentos" class="h-5/6 mb-20">
                <div class="mb-2">
                    <form action="{{ url('/validacao-documentos') }}" method="GET">
                        <div class="flex">
...
@foreach ($prescribers as $p)
<div data-modal-backdrop="static" id="editModal-{{ $p->id }}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
