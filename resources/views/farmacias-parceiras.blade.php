        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-6 space-y-6">
                    ...
                    <div class="flex h-[120px]">
                        <div class="flex flex-wrap justify-end items-start h-[40px]">
                                ...
                                <label class="px-5 py-2.5 mb-2.5 text-xs rounded-lg bg-gray-300 cursor-pointer w-fit">
                                    Escolher Arquivo
                                    <input type="file" name="foto" id="imageUpload" accept="image/*" class="hidden">
                                </label>
                ...
                <div>
                    ...
                    <input type="text" id="cep" value="" onChange="fetchAddressInfo(this)" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="">
                </div>
                <div>
                ...
                <div class="flex justify-between">
                    ...
                    <div class="flex h-[120px]">
                        <div class="flex flex-wrap justify-end items-start h-[40px]">
                                ...
                                <label class="px-5 py-2.5 mb-2.5 text-xs rounded-lg bg-gray-300 cursor-pointer w-fit">
                                    Escolher Arquivo
                                    <input type="file" id="imageUpload-{{$c->id}}" onChange="uploadImage(this, {{$c->id}})" accept="image/*" class="hidden">
                                </label>
                            <div>
                                <img class="w-20 h-20 rounded-sm" id="previewImage-{{$c->id}}" src="{{$c->foto}}" alt="Preview Image">
                            </div>
                        </div>
                    </div>
                </div>
